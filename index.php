            ...
            <form action="" method="post">
                <div class="row">
                    <div class="mb-3 col-3">
                        ...
                        <input type="text" class="form-control" id="primer_nombre" aria-describedby="primer_nombre_Help">
                    </div>

                    <div class="mb-3 col-3">
                        <label for="segundo_nombre" class="form-label">Segundo Nombre</label>
                        <input type="text" class="form-control" id="segundo_nombre" aria-describedby="segundo_nombre_Help">
                    </div>

                    <div class="mb-3 col-3">
                        <label for="primer_apellido" class="form-label">Primer Apellido</label>
                        <input type="text" class="form-control" id="primer_apellido" aria-describedby="primer_apellido_Help">
                    </div>
                    <div class="mb-3 col-3">
                        <label for="segundo_apellido" class="form-label">Segundo Apellido</label>
                        <input type="text" class="form-control" id="segundo_apellido" aria-describedby="segundo_apellido_Help">
                    </div>
                </div>
